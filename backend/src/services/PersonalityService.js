/**
 * PersonalityService
 * Pure detection function that assigns a tasting personality based on rating patterns.
 * Evaluates 11 prioritized rules — first match wins.
 * Imported by DashboardService and SimilarityService.
 */
...
export function detectPersonality(input) {
  const {
    ratings, ratingDistribution, averageRating,
    totalRatings, totalItems, maxRating,
    noteCount, noteLengths,
