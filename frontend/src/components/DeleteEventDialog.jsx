 ...
 * 
 * A modal dialog for confirming event deletion with a confirmation phrase.
 * Requires the user to type "DELETE" to confirm the destructive action.
 * 
 ...
 * @param {string} eventName - Name of the event being deleted (for display)
